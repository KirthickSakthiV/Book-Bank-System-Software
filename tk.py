...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def Entry_page(self):
        ...
        # Buttons
        btn1 = Button(frame0, text="Login/Register", bg='orange', fg='black', border=0,font=('Popins', 10),command=self.login)
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def login(self):
        def fun1():
            ...
            def check():
                ...
                if username1=='' or passingword=='':
                    ...
                    try:
                        ...
                        return
                    try:
                        q="select * from userdata where username=%s and createpassword=%s"
                        cursor.execute(q,(username1,passingword))
                        row=cursor.fetchall()
                    except Exception as e:
                        print(e,2)
                        messagebox.showerror("Sorry","Table connection failed")
                        return
                    if row==None:
            ...
            # Sign in text
            heading = Label(frame, text="Login", fg='blue', bg='White', font=('Popins', 23, 'bold'))
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def register(self):
        ...
        def get_data():
            ...
            if username1=='' or CPassword1=='' or RPassword1=='':
                messagebox.showerror("Invalid","All feilds are required")
        ...
        # Sign in button
        sign_in = Button(frame1, width=6, text='Login', bg='white', fg='blue',border=0, cursor='hand2',command=self.login1)
        sign_in.place(x=200, y=340)
        # Home Button
        Button(screen1, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page4).place(x=15, y=25)
        screen1.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------    
    def select_book(self):
        ...
        author1=StringVar()
        quantity1=StringVar()
        b_name = OptionMenu(frame2,var,*option).place(x = 170, y = 100)  
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def return_book(self):
        ...
        bor_date=StringVar()
        ret_date=StringVar()
        b_name = OptionMenu(frame3,bo_name,*option1).place(x = 190, y = 100)
